...
This project focuses on analyzing historical flight data from **Delhi to major Indian cities** (e.g., Mumbai, Bangalore, Hyderabad) to better understand pricing mechanisms and build predictive models.
...
- **Deep Learning (optional):** PyTorch, Transformers  
